  ...
  \section{Experience}
    \resumeSubHeadingListStart
      \resumeSubheading
        ...
        \resumeItemListStart
          \item\small{{Implementing an OpenGL ES 3.0/OpenGL 3.3+ based rendering engine from scratch for Blackberry's QNX RTOS and Microsoft Windows, respectively. The engine relies on Qt framework for window management and user inputs from the screens in the automobile.}}
